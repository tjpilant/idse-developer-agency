...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  projects/$PROJECT/sessions/$SESSION/intents/"
    echo "  projects/$PROJECT/sessions/$SESSION/contexts/"
    echo "  projects/$PROJECT/sessions/$SESSION/specs/"
    echo "  projects/$PROJECT/sessions/$SESSION/plans/"
    echo "  projects/$PROJECT/sessions/$SESSION/tasks/"
    echo "  projects/$PROJECT/sessions/$SESSION/implementation/"
    echo "  projects/$PROJECT/sessions/$SESSION/feedback/"
else
    echo ""
