...
- IDSE_Core repo; Status Browser patterns for storage/routes/governance.
- Python 3.11+, local/CI runners; filesystem-scoped artifacts and reports.
- No mandatory network; governance scripts run locally/CI.
